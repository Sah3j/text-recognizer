...
function MainContent() {
    ...
    return (
      <div>
        <h1 class="mb-4 text-3xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-6xl"><span class="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">Text Recognizer</span></h1>

        {selectedImage ? 
          <>
            <img class="h-auto max-w-full" src={URL.createObjectURL(selectedImage)} alt="image description"></img>
        ...
        {selectedImage ? (
          recognizedText? <p>{recognizedText}</p> : <p>No text recognized yet</p>) : 
          <p>Upload or capture an image to recognize text</p>
          }
